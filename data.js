  ...
  "categories": [
      ...
      "questions": [
        {
          ...
          "answer": "Osnovne karakteristike su: on-demand pristup resursima, pristup preko mreže, deljenje resursa među korisnicima, brza elastičnost, merenje potrošnje i visok stepen automatizacije kroz API-je i orkestraciju."
        },
        {
          "id": 2,
          "question": "Koji su osnovni Cloud servisi koji se mogu zakupiti kod Cloud provajdera?",
          "answer": "Najčešće se zakupljuju računarski resursi, skladište podataka, mrežni servisi, baze podataka kao servis i bezbednosni servisi. U širem smislu zakup obuhvata i IaaS, PaaS i SaaS modele."
        },
        {
          "id": 3,
        ...
        },
        {
          ...
          "answer": " Cloud pripada klasi HTC sistema, jer je cilj obrada velikog broja korisničkih zahteva/transakcija u vremenu kroz distribuiranu i skalabilnu infrastrukturu."
        },
        {
          "id": 6,
          "question": "Definisati osnovne načine skaliranja Cloud infrastrukture i servisa.",
          "answer": "Osnovni načini su: vertikalno skaliranje, horizontalno skaliranje i automatsko skaliranje na osnovu metrika opterećenja, rasporeda ili događaja."
        },
        {
          "id": 7,
        ...
        },
        {
          ...
          "answer": "Osnovne gradivne tehnologije su: virtuelizacija, distribuirani sistemi, kontejneri i orkestracija, automatizacija i Infrastructure as Code, API/web servisi, kao i softverski definisane mreže i skladište."
        },
        {
          "id": 9,
        ...
        },
        {
          ...
          "answer": "Načini implementacije su: javni cloud, privatni cloud, hibridni cloud, community cloud i multi-cloud pristup."
        },
        {
          "id": 11,
          "question": "Objasnite IaaS ",
        ...
        {
          "id": 12,
          "question": "Objasnite PaaS ",
          "answer": "PaaS pruža gotovu platformu za razvoj i pokretanje aplikacija. Prednosti: brži razvoj, manje operativnog održavanja, standardizovano okruženje. Nedostaci: manja kontrola nad platformom i veći rizik lock-in-a. Primeri: Azure App Service, Google App Engine, Heroku."
        },
        {
          "id": 13,
          "question": "Objasnite SaaS ",
        ...
        },
        {
          ...
          "answer": "Javna cloud infrastruktura je okruženje u vlasništvu cloud provajdera gde se resursi dele među korisnicima, a pristup je preko interneta. Prednosti su visoka skalabilnost i niža početna ulaganja, dok su izazovi kontrola i regulatorni zahtevi."
        },
        {
          "id": 15,
        ...
        },
        {
          ...
          "answer": "Multi-cloud znači istovremeno korišćenje usluga više cloud provajdera. Ciljevi su smanjenje zavisnosti od jednog provajdera, optimizacija troška/performansi i veća otpornost, ali uz veću složenost upravljanja i bezbednosti."
        }
      ]
    },
    {
      ...
      "questions": [
        ...
        },
        {
          ...
          "answer": "Tier 1: osnovna infrastruktura bez redundanse, planirani i neplanirani prekidi su češći. Tier 2: delimična redundansa ključnih komponenti, bolja pouzdanost od Tier 1. Tier 3: concurrently maintainable, održavanje je moguće bez gašenja IT opterećenja, značajno viša dostupnost i otpornost."
        },
        {
          "id": 21,
          "question": "Objasni princip rangiranja data centara u pogledu pouzdanosti i raspoloživosti?",
          "answer": "Rangiranje se zasniva na stepenu redundanse, toleranciji na kvarove, mogućnosti održavanja bez prekida, kao i očekivanom procentu raspoloživosti. Što je više nezavisnih rezervnih puteva i komponenti, centar dobija viši rang i manji rizik prekida."
        },
        {
          "id": 22,
        ...
        },
        {
          ...
          "answer": "Osnovni resursi su: compute, storage, networking, napajanje, hlađenje, bezbednost i monitoring/upravljanje."
        },
        {
          "id": 24,
      ...
      "questions": [
        {
          ...
          "answer": "Virtuelizacija je apstrakcija fizičkih resursa u logičke, virtuelne resurse. U data centru mogu se virtuelizovati serveri, mreža, storage, desktop okruženja i delom bezbednosne funkcije."
        },
        {
          "id": 26,
        ...
        },
        {
          ...
          "answer": "Tri osnovne komponente su: 1 fizički host, 2 hipervizor/virtualizacioni sloj, 3 virtuelne mašine/gosti."
        },
        {
          "id": 28,
          "question": "Objasniti ulogu virtuelizacionog sloja i njegov odnos prema fizičkom hardveru i virtuelnim resursima.",
          "answer": "Virtuelizacioni sloj je posrednik između fizičkog hardvera i VM-ova. On mapira fizičke resurse u virtuelne, obezbeđuje izolaciju među gostima i kontroliše pristup CPU-u, memoriji, disku i mreži."
        },
        {
          "id": 29,
        ...
        },
        {
          ...
          "answer": "Fizički resursi postaju virtuelni kroz: sharing, aggregation, emulation i isolation."
        },
        {
          "id": 31,
          "question": "Šta se podrazumeva pod „managed execution“ i zašto je važan?",
        ...
        },
        {
          ...
          "answer": "Mogu se virtuelizovati compute resursi, storage sistemi, mreža, desktop okruženja, aplikacioni sloj i bezbednosne funkcije kroz mrežnu i servisnu virtualizaciju."
        },
        {
          "id": 34,
          "question": "Objasniti pojam serverske virtuelizacije.",
          "answer": "Serverska virtuelizacija je tehnika u kojoj se jedan fizički server deli na više nezavisnih virtuelnih servera. Svaki VM ima svoj OS i aplikacije, kao da je poseban računar."
        },
        {
          "id": 35,
        ...
        },
        {
          ...
          "answer": "Hosted hipervizor radi iznad host operativnog sistema, lakši je za desktop/test scenarije ali ima veći overhead. Bare-metal radi direktno na hardveru, daje bolje performanse, sigurnost i stabilnost za produkciju."
        },
        {
          "id": 37,
        ...
        },
        {
          ...
          "answer": "Računar domaćin je fizička mašina koja obezbeđuje resurse. Računar gost je virtuelna mašina koja koristi te resurse. Hipervizor je softverski sloj koji upravlja host resursima i raspodelom ka guest sistemima."
        },
        {
          "id": 40,
        ...
        },
        {
          ...
          "answer": "Hipervizor upravlja VM životnim ciklusom, planira CPU i memoriju, virtuelizuje I/O, sprovodi izolaciju i pravila pristupa, te omogućava balans opterećenja i HA mehanizme u klasteru."
        },
        {
          "id": 42,
          "question": "Koje su dve osnovne arhitekture hipervizora i po čemu se razlikuju?",
          "answer": "Dve osnovne arhitekture su Type 1 i Type 2. Type 1 radi direktno na hardveru, a Type 2 radi kao aplikacija iznad postojećeg OS-a; razlikuju se po performansama, sigurnosti i nameni."
        },
        {
          "id": 43,
        ...
        {
          "id": 44,
          "question": "Objasniti pojam Puna virtuelizacija ",
          "answer": "Puna virtuelizacija omogućava da neizmenjen gostujući OS radi kao da ima sopstveni hardver. Hipervizor emulira/posreduje hardverske resurse i omogućava kompatibilnost bez modifikacije OS-a gosta."
        },
        {
          "id": 45,
          "question": "Objasniti hardverski podržanu virtuelizaciju",
          "answer": "Hardverski podržana virtuelizacija koristi CPU ekstenzije da ubrza i osigura izvršavanje VM-ova. Time se smanjuje potreba za skupom softverskom emulacijom i poboljšavaju performanse i izolacija."
        },
        {
          "id": 46,
        ...
        {
          "id": 51,
          "question": "Objasni arhitekturu instanci virtuelnih servera sa ravnomernim opterećenjem ",
          "answer": "Load Balanced Virtual Server Instances Architecture koristi više VM instanci iste usluge iza load balancera. Balanser raspodeljuje zahteve po pravilima, čime se postižu veća dostupnost i horizontalna skalabilnost."
        },
        {
          "id": 52,
          "question": "Objasniti pojam VM migracije i navesti osnovne vrste migracije virtuelnih mašina.",
          "answer": "VM migracija je premeštanje virtuelne mašine sa jednog hosta na drugi. Osnovne vrste su: live migration, cold migration, storage migration, i kombinovana compute+storage migracija."
        },
        {
          "id": 53,
        ...
        {
          "id": 54,
          "question": "Objasniti ulogu balansiranja opterećenja i High Availability mehanizama u klasteru serverske virtuelizacije.",
      ...
      "questions": [
        {
          ...
          "answer": "Virtuelizacija desktop okruženja znači da desktop OS i korisničko radno okruženje rade centralno na serverima/data centru ili cloud-u, a korisnik pristupa preko mreže. Prednosti su centralizovana administracija, veća bezbednost, lakši backup i pristup sa različitih uređaja."
        },
        {
          "id": 56,
        ...
        },
        {
          ...
          "answer": "Multitenant tehnologija podrazumeva da jedna platforma uslužuje više korisničkih organizacija uz logičku izolaciju. Tipovi: 1 shared-everything - najjeftinije i najskalabilnije, ali najosetljivije na greške izolacije; 2 shared app, separate schema/database - bolja izolacija i fleksibilnost, uz veće troškove; 3 dedicated instance per tenant - najbolja izolacija i prilagođavanje, ali najskuplja i teža za operativno održavanje."
        }
      ]
    },
    {
      ...
      "questions": [
        {
          "id": 59,
          "question": "Objasniti šta je SAN, a šta NAS.",
          "answer": "SAN je namenska mreža za blokovski pristup skladištu, dok je NAS mrežni uređaj/fajl servis koji daje pristup fajlovima preko protokola kao što su SMB/NFS."
        },
        {
          "id": 60,
        ...
        },
        {
          ...
          "answer": "RAID pool je skup fizičkih diskova organizovanih u RAID nivo radi performansi i/ili redundanse. LUN je logički volumen iz tog pool-a koji se prezentuje serveru kao disk uređaj preko SAN-a."
        },
        {
          "id": 62,
          "question": "Objasniti pojam Object Storage i navesti tipične oblasti njegove primene.",
          "answer": "Object Storage čuva podatke kao objekte u ravnom namespace-u. Tipične primene su backup i arhiva, statički web sadržaj, multimedia, logovi, data lake i cloud-native aplikacije."
        },
        {
          "id": 63,
        ...
        },
        {
          ...
          "answer": "File Storage organizuje podatke kroz fajlove i direktorijume i deli ih mrežnim protokolima. Tipično se koristi za timsko deljenje dokumenata, korisničke profile, zajedničke repozitorijume i sadržaj aplikacija koje traže fajl sistem."
        },
        {
          "id": 65,
          "question": "Navesti i objasniti osnovne vrste RAID konfiguracija",
          "answer": "Osnovne RAID konfiguracije: RAID 0, RAID 1, RAID 5, RAID 6, RAID 10/1+0."
        },
        {
          "id": 66,
    ...
    },
    {
      ...
      "questions": [
        {
          "id": 68,
          "question": "Šta je Software-Defined Storage i koji ključni problem rešava u odnosu na tradicionalne storage sisteme?",
          "answer": "Software-Defined Storage je pristup u kome se upravljanje skladištem odvaja od fizičkog hardvera i realizuje softverski. Ključni problem koji rešava je zavisnost od vendor-specifičnih uređaja i kruta, teško skalabilna arhitektura tradicionalnih storage sistema."
        },
        {
          "id": 69,
        ...
        {
          "id": 73,
          "question": "Na koji način SDS omogućava skaliranje sistema i koje su prednosti tog pristupa?",
          "answer": "SDS se skaluje scale-out pristupom: dodavanjem novih čvorova raste i kapacitet i throughput. Prednosti su linearno skaliranje, manji vendor lock-in, bolja otpornost i mogućnost postepenog širenja sistema."
        },
        {
          "id": 74,
        ...
        },
        {
          ...
          "answer": "Ceph postiže skalabilnost i otpornost kroz distribuiranu arhitekturu, automatsku replikaciju ili erasure coding, CRUSH raspored podataka, self-healing i automatski rebalance kada se čvorovi dodaju ili otkažu."
        },
        {
          "id": 76,
        ...
        {
          "id": 77,
          "question": "Objasni koncept Storage Policy Based Management i njegov značaj u vSAN-u.",
          "answer": "Storage Policy Based Management u vSAN-u znači da se zahtevi aplikacije definišu kroz politike na nivou VM objekata. Time se automatizuje usklađivanje storage ponašanja sa potrebama workload-a."
        },
        {
          "id": 78,
    ...
    },
    {
      ...
      "questions": [
        ...
        {
          "id": 81,
          "question": "Koja je razlika između Cloud Storage Virtualization i Software-Defined Storage?",
          "answer": "SDS primarno virtualizuje i upravlja storage resursima unutar jedne infrastrukture/data centra, dok Cloud Storage Virtualization fokus stavlja na objedinjavanje više cloud/on-prem lokacija u jedan namespace i sloj pristupa preko okruženja."
        },
        {
          "id": 82,
        ...
        },
        {
          ...
          "answer": "Hibridni cloud storage kombinuje lokalni storage i cloud: kritični/često korišćeni podaci ostaju lokalno, a backup, arhiva i burst kapacitet idu u cloud. Raspoređivanje se radi kroz politike po performansama, ceni i usklađenosti."
        },
        {
          "id": 84,
